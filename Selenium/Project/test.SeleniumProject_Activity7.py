...
with webdriver.Firefox(service=service) as driver:
    ...
    Qualification = driver.find_element(By.XPATH, "//*[@id=\"sidenav\"]/li[9]/a")
    Qualification.click()
    ...
    Company.click()
    Company.send_keys("Company1")
    

    JobTitle = driver.find_element(By.XPATH, "//*[@id=\"experience_jobtitle\"]")
    JobTitle.click()
    JobTitle.send_keys("Job Title1")
    
    Save = driver.find_element(By.XPATH, "//*[@id=\"btnWorkExpSave\"]")
    Save.click()
